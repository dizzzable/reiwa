...
<p align="center">
  <a href="https://github.com/dizzzable/reiwa/releases/latest"><img src="https://img.shields.io/badge/version-0.9.7.17-blue" alt="Version" /></a>
...
docker pull ghcr.io/dizzzable/reiwa:v0.9.7.17
```

Доступные теги: `latest` (актуальный main), `v0.9.7.17` (тег релиза), плюс `sha-<short>` для каждого коммита в `main`. Прод-`docker-compose.yml` использует `latest`.
