...
<p align="center">
  <a href="https://github.com/dizzzable/reiwa/releases/latest"><img src="https://img.shields.io/badge/version-0.9.7.44-blue" alt="Version" /></a>
...
docker pull ghcr.io/dizzzable/reiwa:v0.9.7.44
```

Доступные теги: `latest` (последний выпуск — двигается только push'ем тега `v*`), `v0.9.7.44` (тег релиза), `main` (текущая ветка `main`, ещё не выпуск), плюс `sha-<short>` для каждого собранного коммита. Прод-`docker-compose.yml` использует `latest`, то есть получает только выпуски.
