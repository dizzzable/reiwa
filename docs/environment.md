...
- **Последние рабочие копии.** Каждая группа, которую панель отдала, лежит в
  ...
  бота, лендинг, экран подключения, правила доступа, паки эмодзи, поддержка без
  аккаунта. Если панель недоступна, а кабинет или бот перезапустились, они
  работают на этих копиях: лендинг остаётся лендингом, правила доступа —
  прежними (не «пускать всех»), у поддержки без аккаунта остаётся капча.
